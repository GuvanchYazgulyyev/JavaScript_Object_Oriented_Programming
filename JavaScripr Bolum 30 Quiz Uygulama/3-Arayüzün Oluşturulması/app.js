...
function showScore() {
    var html = `<h2>Test Sonucu</h2><h4>${quiz.score}</h4>`;
...
function showProgress() {
    ...
    var html = 'Sorular ' + questionNumber + ' / ' + totalQuestion;

    if (totalQuestion === questionNumber) {
        document.querySelector('#progress').innerHTML = "Test Sonucu";
    } else {
